...
<head>
    ...
    <title>TrueNorth Technology - Login</title>
    <style type="text/css">
        .st0 {
            fill: none;
            stroke: currentColor;
            ...
            <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                ...
                <div class="mt-12">
                        ...
                        <div class="mt-8 relative text-gray-600 focus-within:text-gray-400">
                            <div class="flex justify-between items-center">
                                ...
                                @if (Route::has('password.request'))
                                    <div>
                                        <a href="{{ route('password.request') }}" class="text-xs font-display font-semibold text-indigo-600 hover:text-indigo-800
                                        cursor-pointer">
                                            Esqueceu sua senha?
                                        </a>
                                    </div>
                    ...
                    <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                        Não possui uma conta? <a href="{{ route('register') }}" class="cursor-pointer text-indigo-600 hover:text-indigo-800">Cadastrar</a>
                    </div>
                </div>
            </div>
        </div>
