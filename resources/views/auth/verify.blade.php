...
<head>
    ...
    <title>TrueNorth Technology - Verificar</title>
    <style type="text/css">
        .st0 {
            fill: none;
            stroke: currentColor;
        ...
        <div class="lg:w-1/2 xl:max-w-screen-sm">
            <div class="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                <div class="cursor-pointer flex items-center">
                    ...
                    <div class="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold">TrueNorth Technology
                    </div>
                </div>
            </div>
            @if (session('resent'))
                <div role="alert" class="p-8">
                    ...
                    <div class="border border-t-0 border-green-400 rounded-b bg-green-100 px-4 py-3 text-green-700">
                        <p>Um outro e-mail foi enviado para a sua caixa!</p>
                        <p>Lembre-se de checar a caixa de SPAM.</p>
                    </div>
                </div>
            @endif
            @if (count($errors) > 0)
            ...
            <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                <h2 class="text-center text-4xl text-indigo-900 font-display font-semibold lg:text-left xl:text-5xl
                    xl:text-bold">Confirmar endereço de e-mail</h2>
                <div class="mt-12">
                    <div class="text-gray-400 justify-center">
                        <p>
                            Antes de continuar, confirme o e-mail que foi enviado para a sua caixa de entrada.
                        </p>
                    </div>
